...
class SearchRacesPage extends Component {
  ...
  render() {
    return (
      <View style={styles.flatBg} testID="page_more_races">
        {this.topBar()}
    ...
    return (
      <TouchableOpacity
        ...
        <Image
          ...
          source={global.language === 'zh' ? Images.month : Images.monthE}
        />
      </TouchableOpacity>
    );
  };
    ...
    return (
      <View style={styles.topBar}>
        <TouchableOpacity
          ...
          onPress={this._back}>
          <Image style={styles.imgBack} source={Images.sign_return} />
        </TouchableOpacity>
        ...
        <View style={styles.topRight}>
          ...
          <TouchableOpacity
            ...
            testID="btn_search"
            style={styles.topBtn}>
            <Image style={{width: 22, height: 22}} source={Images.search} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={styles.topBtn}>
            <Image style={{width: 22, height: 22}} source={Images.race_type} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            testID="btn_calendar"
            style={styles.topBtn}>
            <Image style={{width: 22, height: 21}} source={Images.schedule} />
          </TouchableOpacity>
        </View>
      </View>
    );
  ...
  _renderSectionHeader = (sectionData, sectionID) => {
    return (
      <View
        ...
        <Text style={{color: '#4b515a', fontSize: 17, marginTop: 10}}>
          {sectionID}
        </Text>
      </View>
    );
